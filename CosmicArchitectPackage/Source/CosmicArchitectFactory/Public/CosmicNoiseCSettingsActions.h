...
class  FCosmicNoiseCraterSettingsActions : public FAssetTypeActions_Base
{
public:
    // El nombre que aparecerá en el menú
    virtual FText GetName() const override { return FText::FromString("Crater Noise Settings"); }
