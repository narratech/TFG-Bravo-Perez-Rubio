...
public:
	...
	void Initialize(int32 Seed, FCosmicNoiseLayer LayerParameters, FCosmicNoiseBiomeParameters BiomeParameters, FCosmicNoiseCraterParameters CraterParameters);
